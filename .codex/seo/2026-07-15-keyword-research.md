...
本节保留 2026-07-15 的研究判断。持续维护的逐词状态、目标读者、产品依据和落地页统一记录在[候选关键词池](./keyword-pool.md)，后续复盘不回写本节的历史快照。
...
本文件只保留 2026-07-15 当期数据、关键词判断和内容责任，不再重复长期执行规则。候选词当前状态维护在 [`keyword-pool.md`](./keyword-pool.md)；关键词研究、写作、双语、技术检查、发布和 2 至 4 周复盘统一遵守 [`seo-geo-protocol.md`](./seo-geo-protocol.md)。
