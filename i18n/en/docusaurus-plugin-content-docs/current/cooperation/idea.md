...
We welcome feedback from real tasks, including problems you encountered, capabilities you need, and improvements to the documentation or built-in Skills.
...
- Your xAgent version and relevant environment.
- Necessary screenshots or reproduction steps, with sensitive information hidden first.

A clear real-world scenario is easier to evaluate than a feature name alone. For documentation problems, include the page URL and the section that needs attention.
