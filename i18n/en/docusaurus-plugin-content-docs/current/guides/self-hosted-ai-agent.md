...
Run the [official installer](/docs/getting-started/install). It detects the system and architecture, verifies release packages, and installs the current `v0.0.10.beta` release. On Linux it configures and starts a systemd service; on macOS it installs under the current user.
