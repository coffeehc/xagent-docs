...
description: Install and verify xAgent v0.0.5.beta from the server installer through the first system setup flow.
...
The target version is `0.0.5.beta`. On Linux, also check the service:
