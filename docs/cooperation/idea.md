...
欢迎分享你在真实任务中遇到的问题、希望补充的能力，以及对文档或内置 Skill 的改进建议。
...
| [前往社区讨论](/docs/community/discussions) | [提交 Issue](https://github.com/coffeehc/xagent-releases/issues/new) 或 [发送邮件](mailto:xagent@xiagaogao.com) |
...
- 你期望的结果。
- 使用的 xAgent 版本和相关环境。
- 必要的截图或复现步骤，截图应先遮盖敏感信息。

清晰的真实场景比单独的功能名称更容易评估。对于文档问题，请同时提供页面地址和需要调整的位置。
