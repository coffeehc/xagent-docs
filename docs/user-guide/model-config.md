---
title: xAgent 模型配置：Provider、工具调用与任务路由
description: 了解 xAgent 当前模型配置页面、Provider 接入、工具调用能力、连接测试、热切换及未来统一任务路由方向。
status: stable
updated: 2026-07-15
---
...
- [在 Agent 会话中测试模型与工具调用](/docs/user-guide/agent-session)
- [配置智能体可用能力](/docs/user-guide/agent-management)
- [创建一个真实任务验证模型](/docs/getting-started/first-task)
