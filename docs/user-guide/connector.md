...
![我的连接页面](/img/manual/xagent-connector-my-connections.png)
...
![添加 Connector](/img/manual/xagent-connector-add-dialog.png)
...
![Connector 详情](/img/manual/xagent-connector-detail.png)
