...
![xAgent 运行环境检测页面，显示系统组件的就绪与异常状态](/img/manual/xagent-system-components.png)
...
- [确认 AI Agent 模型要求](/docs/deployment/model-requirements)
- [在模型配置中添加并测试模型](/docs/user-guide/model-config)
- [完成第一个 Agent 任务](/docs/getting-started/first-task)
- [按需安装微信或 Telegram Connector](/docs/deployment/connector-install)
